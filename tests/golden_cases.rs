...
golden_test_cases!(
    ...
    html_block_div_attr_name_invalid,
    html_block_div_attr_name_multiline,
    html_block_div_attr_name_nested,
    html_block_div_attr_name_blockquote,
    html_block_div_attr_name_quoted_list,
    html_block_div_attr_name_list,
    html_block_div_attr_name_trailing,
    html_block_div_attr_name_ascii,
    html_block_div_attr_name_valid,
    html_block_div_attr_name_unicode,
    html_block_div_slash_unclosed,
    html_block_div_slash_matched,
    html_block_div_slash_nested,
    html_block_div_slash_blockquote,
    html_block_div_slash_list,
    html_block_div_slash_multiline,
    html_block_div_slash_spaced,
    ...
    multiline_table_reflow_stability,
    ...
    sentence_wrap_trailing_footnotes_536,
