...
math. These differences explain part of the gap, but they do not make all of
Panache's overhead necessary: profiling also found avoidable tree traversals and
text copies in formatting checks. The [investigation
notes](https://github.com/jolars/panache/blob/main/benches/yamark-investigation.md)
record the measured improvements and remaining bottlenecks.
