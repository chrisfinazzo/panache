...
1. **Collection**: All code blocks of the target language are extracted, with
   any enclosing container syntax (block quote markers, list item indentation)
   stripped so the linter sees valid code
