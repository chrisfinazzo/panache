...
External linters analyze code blocks and executable inline expressions together:
...
1. **Collection**: Code blocks and executable inline expressions of the target
   ...
   valid code
2. **Concatenation**: Code is joined, retaining blank-line padding where
   possible
...
code block and used in another block or an inline expression, the linter sees
both the definition and the use.
:::
